...
UsdGeomTokensType::UsdGeomTokensType() :
    ...
    backPlate("backPlate", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_AlphaImage("backPlate:__INSTANCE_NAME__:alpha:image", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_DepthCameraSpaceOffset("backPlate:__INSTANCE_NAME__:depth:cameraSpaceOffset", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_DepthImage("backPlate:__INSTANCE_NAME__:depth:image", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_DepthMinOffset("backPlate:__INSTANCE_NAME__:depth:minOffset", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_DepthNormalizingFactor("backPlate:__INSTANCE_NAME__:depth:normalizingFactor", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_Image("backPlate:__INSTANCE_NAME__:image", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_LumaGain("backPlate:__INSTANCE_NAME__:luma:gain", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_LumaGamma("backPlate:__INSTANCE_NAME__:luma:gamma", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_LumaLift("backPlate:__INSTANCE_NAME__:luma:lift", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_PlateVisibility("backPlate:__INSTANCE_NAME__:plateVisibility", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_RotateXYZTweak("backPlate:__INSTANCE_NAME__:rotateXYZ:tweak", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_ScaleTweak("backPlate:__INSTANCE_NAME__:scale:tweak", TfToken::Immortal),
    backPlate_MultipleApplyTemplate_TranslateTweak("backPlate:__INSTANCE_NAME__:translate:tweak", TfToken::Immortal),
    ...
    exposureFStop("exposure:fStop", TfToken::Immortal),
    exposureIso("exposure:iso", TfToken::Immortal),
    exposureResponsivity("exposure:responsivity", TfToken::Immortal),
    exposureTime("exposure:time", TfToken::Immortal),
    ...
    BackPlateAPI("BackPlateAPI", TfToken::Immortal),
    ...
    allTokens({
        ...
        axis,
        backPlate,
        backPlate_MultipleApplyTemplate_AlphaImage,
        backPlate_MultipleApplyTemplate_DepthCameraSpaceOffset,
        backPlate_MultipleApplyTemplate_DepthImage,
        backPlate_MultipleApplyTemplate_DepthMinOffset,
        backPlate_MultipleApplyTemplate_DepthNormalizingFactor,
        backPlate_MultipleApplyTemplate_Image,
        backPlate_MultipleApplyTemplate_LumaGain,
        backPlate_MultipleApplyTemplate_LumaGamma,
        backPlate_MultipleApplyTemplate_LumaLift,
        backPlate_MultipleApplyTemplate_PlateVisibility,
        backPlate_MultipleApplyTemplate_RotateXYZTweak,
        backPlate_MultipleApplyTemplate_ScaleTweak,
        backPlate_MultipleApplyTemplate_TranslateTweak,
        basis,
        bezier,
        bilinear,
        boundaries,
