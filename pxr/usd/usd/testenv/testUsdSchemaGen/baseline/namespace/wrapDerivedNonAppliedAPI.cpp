...
struct UsdLuxVolumeLightAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    UsdLuxVolumeLightAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static UsdLuxVolumeLightAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = UsdLuxVolumeLightAPI::CanApply(prim, &whyNot);
    return UsdLuxVolumeLightAPI_CanApplyResult(result, whyNot);
}
