...
Test_BasicSwitch()
{
    ...
    // Set the switch controller so Rig1 is active and compute in the forward
    // direction and confirm that we get the values Rig1 computes as authored.
    ...
    // With the switch still set to Rig2, test inverse computation.
    {
    ...
    // Set the switch to Rig1 and test inverse computation again.
    switchAttr.Set(ExecIrSwitchControllerTokens->rig1);
